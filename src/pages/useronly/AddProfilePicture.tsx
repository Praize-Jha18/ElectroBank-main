...
function AddProfilePicture() {
  ...
  return (
    ...
    <div className="w-[90%] mx-auto mt-10 flex flex-col items-center">
        ...
        <button onClick={handleUpload} className="mt-10 w-[30%] focus:bg-whitee mx-auto text-center border-2 border-sky-500 text-white h-[50px] rounded bg-sky-500">Upload</button>
    </div>
    </>
  )
}
